...
%% des Dokuments.
\setzemartrikelnr{1321851}
\setzekurs{STG-TINF15K}
\setzetitel{Qualität einer Bachelorarbeit}
\setzedatumAbgabe{März 2018}
...
\setzezeitraum{4 Wochen}
\setzearbeit{Hausarbeit im Modul Softwarequalität}
\setzeautor{Maximilian Bauknecht}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
